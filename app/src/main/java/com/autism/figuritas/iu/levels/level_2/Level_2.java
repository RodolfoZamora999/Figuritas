...
public class Level_2 extends AbstractLevel
{
    ...
    {
        return inflater.inflate(R.layout.fragment_level_2, null);
    }
    ...
    public void terminatedLevel(int totalShapes)
    {
        ...
        bundleData.putInt("next_level", R.id.action_level_2_to_level_3);

        StatisticsLevelDialog statisticsLevelDialog =  new StatisticsLevelDialog();
        statisticsLevelDialog.setArguments(bundleData);
        statisticsLevelDialog.show(getActivity().getSupportFragmentManager(), "fragment_level_2");
    }
}